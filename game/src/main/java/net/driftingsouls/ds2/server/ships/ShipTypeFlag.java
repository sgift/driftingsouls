...
{
	/**
	 * Kennzeichnet das Schiff als Jäger / Bomber.
	 */
	JAEGER("jaeger", "Jäger / Bomber ", "Jäger und Bomber können auf Trägerschiffen landen."),
	 ...
	 */
	SRS_EXT_AWAC("srs_ext_awac", "erweiterte AWACS-SRS", "Mit den verbesserten AWACS-Kurzstreckensensoren ist eine detailierte Analyse von Antriebshitze, von der Crew und den Enegiereserven eines anderen Schiffes im selben Sektor möglich."),
	 ...
	 */
	NICHT_PLUENDERBAR("nicht_pluenderbar", "nicht plünderbar", "Dieses Schiff kann nicht geplündert werden."),
	 ...
	 * Das Schiff kann sich mit anderen Werften zu Werftkomplexen zusammenschliessen.
	 */
	TRADEPOST("tradepost", "Handelsposten", "Bei diesem Schiff handelt es sich um einen Handelsposten. Dies ermöglicht ihm den An- und Verkauf beliebiger Waren."),
