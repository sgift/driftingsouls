...
public class AngriffController extends Controller
{
    ...
    if(ownShip.getShip().isDocked() || ownShip.getShip().isLanded())
		...
		t.setVar(	"global.ksaction",			ksaction,
					...
					"ownside.secondrow.exists", ownFokusRow == "second" ? battle.hasSecondRow(battle.getOwnSide()) : false,
					"ownside.secondrow.stable",battle.isSecondRowStable(battle.getOwnSide()),
					"ownside.frontrow.exists", ownFokusRow == "front" ? battle.hasFrontRow(battle.getOwnSide()) : false,
					"ownside.joinflucht.exists", ownFokusRow == "join" ? battle.hasJoinFluchtRow(battle.getOwnSide()) : false,
					"enemyside.secondrow.exists", enemyFokusRow == "second" ? battle.hasSecondRow(battle.getEnemySide()) : false,
					"enemyside.frontrow.exists", enemyFokusRow == "front" ? battle.hasFrontRow(battle.getEnemySide()) : false,
					"enemyside.joinflucht.exists", enemyFokusRow == "join" ? battle.hasJoinFluchtRow(battle.getEnemySide()) : false,
