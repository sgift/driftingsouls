...
public class ObjectLabelGenerator
{
	 ...
	 */
	public String generateFor(@Nullable Object identifier, @Nonnull Object entity)
	{
		...
		{
			identifier = db.getEntityManagerFactory().getPersistenceUnitUtil().getIdentifier(entity);
		}
