...
public class ShipTypes {
	...
	static {
		...
		shipTypeFlagNames.put(SF_NICHT_ZERSTOERBAR, "Keine Selbstzerst”rung");
		...
		shipTypeFlagDescs.put(SF_NICHT_ZERSTOERBAR, "Dieses Schiff verfgt ber keine Selbstzerst”rungsanlage");
	}
