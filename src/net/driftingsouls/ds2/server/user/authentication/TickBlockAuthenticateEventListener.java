...
import net.driftingsouls.ds2.server.framework.authentication.AuthenticateEventListener;
import net.driftingsouls.ds2.server.framework.authentication.AuthenticationException;
import net.driftingsouls.ds2.server.framework.pipeline.Request;

/**
 * Listener fuer Authentifizierungsereignisse der sicher stellt, dass auf Accounts
 * waehrend sie vom Tick gesperrt sind, nicht zugegriffen werden kann.
 * @author Christopher Jung
 *
 */
public class TickBlockAuthenticateEventListener implements AuthenticateEventListener {
	public void onAuthenticate(BasicUser basicUser) throws AuthenticationException {
