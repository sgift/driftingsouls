...
public class ResearchEdit implements AdminPlugin {
	...
	public void output(AdminController controller, String page, int action) throws IOException {
		...
		if( techid <= 0 ) {
			...
			echo.append("<tr>");
			echo.append("<td class=\"noBorderX\"><img src=\"./data/tech/"+techid+".gif\" alt=\"Kein Bild vorhanden\" /></td>");
			...
			echo.append("<img style=\"vertical-align:middle\" src=\"./data/interface/time.gif\" alt=\"Dauer\" />"+research.getTime());
