...
public class EditShipCosts extends AbstractEditPlugin8<ShipBaubar>
{
	...
	{
		super(ShipBaubar.class);
	}

	@Override
	protected void configureFor(@Nonnull EditorForm8<ShipBaubar> form)
	{
		form.allowAdd();
		...
		form.field("Forschung 1", Forschung.class, Integer.class, (sb) -> sb.getRes(1), ShipBaubar::setRes1);
		form.field("Forschung 2", Forschung.class, Integer.class, (sb) -> sb.getRes(2), ShipBaubar::setRes2);
		form.field("Forschung 3", Forschung.class, Integer.class, (sb) -> sb.getRes(3), ShipBaubar::setRes3);
