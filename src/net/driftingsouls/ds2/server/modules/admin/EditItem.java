...
public class EditItem implements AdminPlugin
{
	...
	public void output(AdminController controller, String page, int action) throws IOException
	{
		...
		if(itemid != 0)
		{
			...
			echo.append("<tr><td class=\"noBorderS\">Bild (groﬂ): </td><td><input type=\"text\" name=\"largepicture\" value=\"" + (item.getLargePicture() == null ? "" : item.getLargePicture()) + "\"></td></tr>\n");
			echo.append("<tr><td class=\"noBorderS\">Cargo: </td><td><input type=\"text\" name=\"cargo\" value=\"" + item.getCargo() + "\"></td></tr>\n");
			echo.append("<tr><td class=\"noBorderS\">Qualit‰t: </td><td><input type=\"text\" name=\"quality\" value=\"" + item.getQuality() + "\"></td></tr>\n");
