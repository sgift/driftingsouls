	...
	public void show(StatsController contr, int size) throws IOException {
		...
		for( Object o : tmp )
		{
			...
			ShipType st = (ShipType)data[0];
      		echo.append("<tr><td align='right'>"+
      				Common.ln((Long)data[1])+"</td><td>"+st.getNickname()+
      				" <a class=\"forschinfo\" onclick='ShiptypeBox.show("+st.getId()+");return false;' href=\"./ds?module=schiffinfo&ship="+st.getId()+"\">(?)</a>" +
      			"</td></tr>\n");
		}
