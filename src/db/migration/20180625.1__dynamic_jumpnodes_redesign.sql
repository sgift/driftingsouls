...
create table dynamic_jumpnode (id integer not null auto_increment, dynamic_jn_config_id integer not null, initialTicksUntilMove integer not null, remainingTicksUntilMove integer not null, remainingLiveTime integer not null, jumpnode_id integer, primary key (id)) ENGINE=InnoDB;
