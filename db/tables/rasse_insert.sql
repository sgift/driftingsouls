insert into rasse (id, name, head_id, playable, playableext) VALUES (0, 'GCP', -10, false, false);
insert into rasse (id, name, head_id, playable, memberIn_id, personenNamenGenerator, description, playableext) VALUES (1, 'Terraner', null, true, 0, 'ENGLISCH', '[align=left]
...
[/list]
[/align]', false);
insert into rasse (id, name, head_id, playable, memberIn_id, personenNamenGenerator, description, playableext) VALUES (2, 'Vasudaner', null, true, 0, 'AEGYPTISCH', '[align=left]
